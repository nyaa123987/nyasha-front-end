    ...
    <section className="max-w-7xl mx-auto px-8 py-16 md:py-40">
      ...
      <div className="mt-4 md:mt-2 flex flex-wrap justify-center gap-4 md:gap-10">
        {skills.map((skill) => (
          <div
            key={skill}
            className="px-4 py-2 md:px-6 md:py-3 rounded-xl md:rounded-full bg-[#1d0b55] flex items-center justify-center md:font-semibold text-sm md:text-xl shadow-lg text-white"
          >
            {skill}
          </div>
        ))}
