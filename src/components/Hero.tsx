...
export default function Hero() {
  return (
    <section className="relative text-white w-full h-[70vh] md:h-[90vh] pt-[2vh] px-[3%] flex flex-col-reverse text-center justify-center landscape:flex-row landscape:items-center overflow-hidden">
